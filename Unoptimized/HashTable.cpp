...
static size_t WhackyHash2_SIMD(void* Key, size_t len, size_t MaxValue)
{
    ...
    __m256i MLGm256 = _mm256_set1_epi64x(MLG);
    __m256i tony256 = _mm256_set1_epi64x(tony);
    ...
    __m256i SubSums256 = {HashSubSums[0], HashSubSums[1], HashSubSums[2], HashSubSums[3]};
